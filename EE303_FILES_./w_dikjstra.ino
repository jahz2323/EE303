...
void dijkstra(Queue<int, 5>& myQueue, int graph[7][7], int src, int dest) {
  int dist[7];  // Array to store the shortest distances
  bool sptSet[7];  // Array to track whether a vertex is included in the shortest path tree
